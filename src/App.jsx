        ...
        <div class="max-w-6xl mx-auto h-full">
          ...
          <Show when={!ageConfirmed()}>
            <div class="bg-white p-6 rounded-lg shadow-md text-center">
              <p class="text-xl font-semibold mb-4">The features of this app are intended for users aged 18 and above.</p>
              <button
                class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-6 rounded-full shadow-md transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer"
              ...
              <div class="col-span-1 md:col-span-2 lg:col-span-1">
                ...
                <div class="space-y-4">
                  <button
                    ...
                    disabled={loading()}
                  >
                    <Show when={loading()}>Processing...</Show>
                  ...
                  >
                    <Show when={loading()}>Processing...</Show>
                    <Show when={!loading()}>Generate Markdown</Show>
                  </button>
                </div>
              </div>
            </div>
